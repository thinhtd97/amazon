import { 
    ...
    USER_UPDATE_FAIL,
    USER_UPDATE_REQUEST,
    USER_UPDATE_SUCCESS} from '../contstants/userConstant'
...
export const getProfileUser = (id) => async (dispatch, getState) => {
    try {
        dispatch({
...
export const getDetailsUser = (id) => async (dispatch, getState) => {
    try {
        dispatch({
